...
Public Class Utils
    ...
    Public Shared UserLogin As New CtrlSoft.Dto.Model.MUser
    Public Shared SettingPerusahaan As New Model.SettingPerusahaan
    Public Shared UserOtorisasi As New CtrlSoft.Dto.Model.MUser
    Public Shared IsEditReport As Boolean = False
    Public Shared Dataset As New CtrlSoft.Dto.Model.Dataset
