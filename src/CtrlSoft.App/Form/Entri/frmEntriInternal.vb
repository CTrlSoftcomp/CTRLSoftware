        ...
        Using frm As New frmOtorisasi
            Try
                If frm.ShowDialog(Me) = System.Windows.Forms.DialogResult.OK Then
                    ...
                    gvGudangTujuan.SaveLayoutToXml([Public].SettingPerusahaan.PathLayouts & Me.Name & gvGudangTujuan.Name & ".xml")
        ...
        If SimpanData() Then
            ...
            ElseIf pStatus = pStatusForm.Edit OrElse pStatus = pStatusForm.TempInsert Then
                ...
                For Each frm In Me.MdiParent.MdiChildren
                    ...
                    TryCast(frm, frmDaftarTransaksi).Name.ToString = IIf(pForm = modMain.FormInternal.MutasiGudang, modMain.FormName.DaftarMutasiGudang.ToString,
