                                ...
                                Try
                                    ...
                                    If Not DxErrorProvider1.HasErrors Then
                                        ...
                                        If pStatus = pStatusForm.Baru Then
                                            ...
                                            com.CommandText = "INSERT INTO [dbo].[MAlamat] ([NoID],[Kode],[Nama],[NamaAlias],[Alamat],[Kota],[HP],[Telp],[ContactPerson],[LimitHutang],[LimitPiutang],[LimitNotaPiutang],[LimitUmurPiutang],[IDTypeHarga],[IsActive],[IsSupplier],[IsPegawai],[IsCustomer]) " & vbCrLf &
                                        ...
                                        Else
                                            com.CommandText = "UPDATE [dbo].[MAlamat] SET [Kode]=@Kode,[Nama]=@Nama,[NamaAlias]=@NamaAlias,[Alamat]=@Alamat,[Kota]=@Kota," & vbCrLf &
                                                              "[HP]=@HP,[Telp]=@Telp,[ContactPerson]=@ContactPerson,[LimitHutang]=@LimitHutang,[LimitPiutang]=@LimitPiutang," & vbCrLf &
                                                              "[LimitNotaPiutang]=@LimitNotaPiutang,[LimitUmurPiutang]=@LimitUmurPiutang,[IDTypeHarga]=@IDTypeHarga,[IsActive]=@IsActive," & vbCrLf &
                                                              "[IsSupplier]=@IsSupplier,[IsPegawai]=@IsPegawai,[IsCustomer]=@IsCustomer" & vbCrLf &
                                                              "WHERE NoID=@NoID"
                                        End If
                                        com.Parameters.Clear()
                                        com.Parameters.Add(New SqlParameter("@NoID", SqlDbType.BigInt)).Value = NoID
