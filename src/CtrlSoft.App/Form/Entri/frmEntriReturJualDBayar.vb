...
Public Class frmEntriReturJualDBayar
    Public iList As New List(Of Pembayaran)
    ...
    Private Sub mnTambah_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles mnTambah.ItemClick
        Try
            For Each obj In iList
                ...
                End If
            Next
            iList.Add(New Pembayaran With {.IDJenisPembayaran = 1, .IsBank = False, .Nominal = 0.0, .ChargeProsen = 0.0, .ChargeRp = 0.0, .Total = 0.0})
                    ...
                    Using ds As New DataSet
                        Try
                            ...
                            For Each iRow As DataRow In ds.Tables("MJenisPembayaran").Rows
                                Obj = New Pembayaran With {.NoID = NullToLong(iRow.Item("NoID")), _
    ...
    Public Sub New(ByVal IDCustomer As Long, ByVal Total As Double, ByVal iList As List(Of Pembayaran))
