...
Public Class frmEntriSaldoAwalPiutang
                    ...
                    Using oDA As New SqlDataAdapter
                        Using ds As New DataSet
                            Try
                                ...
                                If NoID >= 1 Then
                                    com.CommandText = "SELECT IDCustomer FROM MSaldoAwalPiutang(NOLOCK) WHERE NoID=" & NoID
                                ...
                                com.CommandText = "SELECT * FROM MSaldoAwalPiutang WHERE NoID=" & NoID
                                oDA.Fill(ds, "MSaldoAwalPiutang")

                                If ds.Tables("MSaldoAwalPiutang").Rows.Count >= 1 Then
                                    Dim iRow As DataRow = ds.Tables("MSaldoAwalPiutang").Rows(0)
                                    ...
                                    txtKontak.EditValue = NullToLong(iRow.Item("IDCustomer"))
                                ...
                                Try
                                    ...
                                    If Not DxErrorProvider1.HasErrors Then
                                        If pStatus = pStatusForm.Edit OrElse pStatus = pStatusForm.TempInsert Then
                                            com.CommandText = "SELECT IsPosted FROM MSaldoAwalPiutang(NOLOCK) WHERE NoID>=1 AND NoID=" & NoID
                                        ...
                                        If Not DxErrorProvider1.HasErrors Then
                                            ...
                                            If pStatus = pStatusForm.Edit OrElse pStatus = pStatusForm.TempInsert Then
                                                com.CommandText = "SELECT COUNT(Kode) FROM MSaldoAwalPiutang WHERE Kode=@Kode AND NoID<>@NoID"
                                            ...
                                            com.CommandText = "[dbo].[spSimpanMSaldoAwalPiutang] " & vbCrLf &
                                                              "@NoID " & vbCrLf &
                                                              ",@Kode " & vbCrLf &
                                                              ",@KodeReff " & vbCrLf &
                                                              ",@Tanggal " & vbCrLf &
                                            ...
                                            com.Parameters.Add(New SqlParameter("@IDCustomer", SqlDbType.Int)).Value = NullTolInt(txtKontak.EditValue)
