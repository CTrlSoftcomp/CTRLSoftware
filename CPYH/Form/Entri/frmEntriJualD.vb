                        ...
                        Using oDA As New SqlDataAdapter
                            Using ds As New DataSet
                                Try
                                    ...
                                    com.CommandText = "SELECT SUM((QtyMasuk-QtyKeluar)*Konversi) FROM MKartuStok WHERE IDGudang=" & NullToLong(frmPemanggil.txtGudang.EditValue) & " AND IDBarang=" & IDBarang & " AND Tanggal<=GETDATE()"
                                    ...
                                    If Not DxErrorProvider1.HasErrors Then
                                        If pStatus = pStatusForm.Baru Then
                                            ...
                                            com.CommandText = "INSERT INTO [dbo].[MJualD] ([NoID],[IDHeader],[IDBarangD],[IDBarang],[IDSatuan],[Konversi],[Qty]" & vbCrLf & _
                                        ...
                                        Else
                                            com.CommandText = "UPDATE [dbo].[MJualD] SET [IDBarangD]=@IDBarangD,[IDBarang]=@IDBarang,[IDSatuan]=@IDSatuan,[Konversi]=@Konversi,[Qty]=@Qty" & vbCrLf & _
                    ...
                    Using oDA As New SqlDataAdapter
                        Using ds As New DataSet
                            Try
                                ...
                                com.CommandText = "SELECT MBarangD.IDBarang, MBarang.Kode, MBarang.Nama, MBarangD.IDSatuan, " & IIf(IDTypeHarga = 2, "MBarangD.HargaJualB", "MBarangD.HargaJualA") & " AS HargaJual FROM MBarang INNER JOIN MBarangD ON MBarang.NoID=MBarangD.IDBarang WHERE MBarangD.NoID=" & NullToLong(txtBarcode.EditValue)
                                oDA.Fill(ds, "MBarang")
