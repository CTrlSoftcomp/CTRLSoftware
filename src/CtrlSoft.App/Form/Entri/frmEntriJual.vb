...
#Region "Init Data"
    ...
    Private ListPembayaran As New List(Of Pembayaran)
                    ...
                    Using oDA As New SqlDataAdapter
                        Using ds As New DataSet
                            Try
                                ...
                                ListPembayaran = New List(Of Pembayaran)
                                If Not pStatus = pStatusForm.Baru Then
                                    ...
                                    For Each iRow As DataRow In ds.Tables("MJualDBayar").Rows
                                        ListPembayaran.Add(New Pembayaran With {.NoID = NullToLong(iRow.Item("NoID")), _
