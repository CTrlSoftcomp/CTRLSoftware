...
Public Class frmEntriReturJualDBayar
    Public iList As New List(Of CtrlSoft.Dto.Model.Pembayaran)
    ...
    Private Sub mnTambah_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles mnTambah.ItemClick
        Try
            For Each obj In iList
                ...
                End If
            Next
            iList.Add(New CtrlSoft.Dto.Model.Pembayaran With {.IDJenisPembayaran = 1, .IsBank = False, .Nominal = 0.0, .ChargeProsen = 0.0, .ChargeRp = 0.0, .Total = 0.0})
    ...
    Private Function GetJenisPembayaran(ByVal NoID As Long) As CtrlSoft.Dto.Model.Pembayaran
        Dim Obj As New CtrlSoft.Dto.Model.Pembayaran
                    ...
                    Using ds As New DataSet
                        Try
                            ...
                            For Each iRow As DataRow In ds.Tables("MJenisPembayaran").Rows
                                Obj = New CtrlSoft.Dto.Model.Pembayaran With {.NoID = NullToLong(iRow.Item("NoID")), _
                            ...
                            Next
                        Catch ex As Exception
                            Obj = New CtrlSoft.Dto.Model.Pembayaran
                        End Try
                    End Using
                End Using
            End Using
    ...
    Private Sub GridView1_CellValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        Dim pembayaran As CtrlSoft.Dto.Model.Pembayaran
        Try
    ...
    Public Sub New(ByVal IDCustomer As Long, ByVal Total As Double, ByVal iList As List(Of CtrlSoft.Dto.Model.Pembayaran))
    ...
    Private Sub frmEntriReturJualDBayar_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        InitLoadLookUpPO()
        RefreshData()
    End Sub
