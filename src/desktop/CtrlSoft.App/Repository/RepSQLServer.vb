...
Namespace Repository
    Public Class RepSQLServer
                            ...
                            Using ds As New DataSet
                                Try
                                    ...
                                    For Each iRow As DataRow In ds.Tables("MUser").Rows
                                        User = New CtrlSoft.Dto.Model.MUser With {.TanggalSystem = Now(), _
                                        ...
                                        For Each aRow As DataRow In ds.Tables("MUserD").Rows
                                            Dim Menu As New CtrlSoft.Dto.Model.Menu With {.NoID = NullToLong(aRow.Item("NoID")), _
                                            ...
                                            For Each bRow As DataRow In ds.Tables("MUserDD").Rows
                                                Menu.SubMenu.Add(New CtrlSoft.Dto.Model.SubMenu With {.NoID = NullToLong(bRow.Item("NoID")), _
                        ...
                        Using oDA As New SqlDataAdapter
                            Using ds As New DataSet
                                Try
                                    ...
                                    oDA.Fill(ds, "MUser")
                                    For Each iRow As DataRow In ds.Tables("MUser").Rows
                                        User = New CtrlSoft.Dto.Model.MUser With {.NoID = NullToLong(iRow.Item("NoID")), _
                                                                     .Nama = NullToStr(iRow.Item("Nama")), _
                                                                     .Kode = NullToStr(iRow.Item("Kode")), _
                                                                     .Role = NullToStr(iRow.Item("Role")), _
                                                                     .Supervisor = NullToBool(iRow.Item("IsSupervisor"))}
        ...
        Public Shared Function GetTimeServer() As Date
            ...
            Return Hasil
        End Function
        Public Shared Function GetListKategori() As List(Of CtrlSoft.Dto.Model.Core)
            Dim Hasil As New List(Of CtrlSoft.Dto.Model.Core)
            Using dlg As New WaitDialogForm("Sedang merefresh data ...", NamaAplikasi)
                Using cn As New SqlConnection(StrKonSQL)
                    Using com As New SqlCommand
                        Using oDA As New SqlDataAdapter
                            Using dt As New DataTable
                                Try
                                    ...
                                    For Each iRow As DataRow In dt.Rows
                                        Hasil.Add(New CtrlSoft.Dto.Model.Core With {.NoID = NullToLong(iRow.Item("NoID")), _
                                                                       .Kode = NullToStr(iRow.Item("Kode")), _
            ...
            Return Hasil
        End Function
        Public Shared Function GetListDepartemen() As List(Of CtrlSoft.Dto.Model.Core)
            Dim Hasil As New List(Of CtrlSoft.Dto.Model.Core)
            Using dlg As New WaitDialogForm("Sedang merefresh data ...", NamaAplikasi)
                Using cn As New SqlConnection(StrKonSQL)
                    Using com As New SqlCommand
            ...
            Return Hasil
        End Function
        Public Shared Function GetListSupplier() As List(Of CtrlSoft.Dto.Model.Core)
            Dim Hasil As New List(Of CtrlSoft.Dto.Model.Core)
            Using dlg As New WaitDialogForm("Sedang merefresh data ...", NamaAplikasi)
                Using cn As New SqlConnection(StrKonSQL)
                    Using com As New SqlCommand
            ...
            Return Hasil
        End Function
        Public Shared Function GetListMerk() As List(Of CtrlSoft.Dto.Model.Core)
            Dim Hasil As New List(Of CtrlSoft.Dto.Model.Core)
            Using dlg As New WaitDialogForm("Sedang merefresh data ...", NamaAplikasi)
                Using cn As New SqlConnection(StrKonSQL)
                    Using com As New SqlCommand
            ...
            Return Hasil
        End Function
        Public Shared Function GetListGudang() As List(Of CtrlSoft.Dto.Model.Core)
            Dim Hasil As New List(Of CtrlSoft.Dto.Model.Core)
            Using dlg As New WaitDialogForm("Sedang merefresh data ...", NamaAplikasi)
                Using cn As New SqlConnection(StrKonSQL)
                    Using com As New SqlCommand
            ...
            Return Hasil
        End Function
        Public Shared Function GetBarangDetil(ByVal Barcode As String) As List(Of CtrlSoft.Dto.Model.Core)
            Dim Hasil As New List(Of CtrlSoft.Dto.Model.Core)
            Using dlg As New WaitDialogForm("Sedang merefresh data ...", NamaAplikasi)
                Using cn As New SqlConnection(StrKonSQL)
                    Using com As New SqlCommand
