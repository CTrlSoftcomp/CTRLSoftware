...
#Region "API Calls"
    ...
    Private Declare Unicode Function WritePrivateProfileString Lib "kernel32" Alias "WritePrivateProfileStringW" (ByVal lpApplicationName As String, _
...
#Region "INIRead Overloads"
    ...
    Private Overloads Function INIRead(ByVal INIPath As String, _
...
#End Region
    ...
    End Function
    Private Shared Sub INIWrite(ByVal INIPath As String, ByVal SectionName As String, _
    ByVal KeyName As String, ByVal TheValue As String)

        Call WritePrivateProfileString(SectionName, KeyName, TheValue, INIPath)

    End Sub
    Private Overloads Sub INIDelete(ByVal INIPath As String, ByVal SectionName As String, _
